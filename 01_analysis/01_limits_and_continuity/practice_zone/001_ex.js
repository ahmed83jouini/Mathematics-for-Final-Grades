...
function verify(exerciseID) {
    ...
    display_universal_validation(
        res, 
        'hint-ex',
         "تأمل جيداً في الرسم.. عندما يقترب x من 0، أين تستقر قيمة f(x) على المحور العمودي؟ محاولة جيدة، لكن راجع حساب مشتقة الدالة الجذرية \frac{u'}{2\sqrt{u}}. أعد المحاولة!",
         ​"ممتاز! لقد استوعبت مفهوم تقارب الصور f(x) عندما يقترب x من الصفر."
    );
